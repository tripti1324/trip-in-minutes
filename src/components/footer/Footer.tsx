        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 items-start">
          ...
          <div className="col-span-1 order-2">
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              ...
              <li><Link to="/about#aboutSection" className="hover:underline">✓ About Us</Link></li>
              ...
              <li><Link to="/privacy-policy#privacyPolicy" className="hover:underline">✓ Privacy Policy</Link></li>
            </ul>
          </div>
